...
const navigation = [
  ...
  { name: 'OKRs', href: '/dashboard/okrs/hierarchy', icon: Target },
  ...
  return (
    <div className="flex h-screen bg-slate-950">
      ...
      <aside className={cn(
        ...
        <div className={cn("relative border-b border-slate-800", isCollapsed ? 'p-4' : 'p-6')}>
          <div className="flex items-center justify-between">
            {!isCollapsed && (
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-400 mt-1">AI-Powered OKRs</p>
              </div>
            )}
            {isCollapsed && (
              <button
          ...
          {!isCollapsed && (
            <button
              ...
              className={cn(
                ...
                "h-9 w-9 rounded-full bg-slate-800 border-2 border-slate-700",
            ...
            >
              <PanelLeftClose className="h-4 w-4 text-slate-300 transition-transform duration-300" />
            </button>
          )}
        </div>
        ...
        <div className="p-4 border-t border-slate-800">
          {!isCollapsed && (
            <button
              ...
              className="flex items-center gap-3 mb-3 px-3 py-2 w-full rounded-md hover:bg-slate-800/50 transition-colors text-left"
          ...
          {isCollapsed && (
            <button
              onClick={() => setIsProfilePopupOpen(true)}
              className="flex items-center justify-center mb-3 w-full rounded-md hover:bg-slate-800/50 transition-colors"
              aria-label="View profile and permissions"
            >
              <div className="h-8 w-8 rounded-full bg-indigo-500 flex items-center justify-center text-sm font-medium text-white">
                {user?.firstName?.[0]}{user?.lastName?.[0]}
