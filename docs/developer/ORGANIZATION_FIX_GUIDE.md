...
2. Run the fix script:
   ```bash
   psql postgresql://okr_user:your_password@localhost:5432/okr_nexus -f scripts/db/fix_users_organization.sql
   ```

   Or copy-paste the SQL from `scripts/db/fix_users_organization.sql` into psql.
